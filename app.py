...
def index():
    ...
    script_bokeh_plot =  server_document(url=f"http://localhost:37629/Omegaplotworkers/plot", arguments={"session_id": session_id})##local_gunicorn: # url=f"http://localhost:37629/Omegaplotworkers/plot"## server: #url=f"https://incandenza-01.zdv.uni-mainz.de/Omegaplotworkers/plot") local_python f"http://localhost:5006/Omegaplotworkers/plot"  #CHANGE FOR SERVER
...
def bk_worker(port):
    ...
    bokeh_tornado = BokehTornado({'/plot': plot_app}, prefix="/Omegaplotworkers", extra_websocket_origins=["*"])
...
worker_ports = [37629] #fixed ports  [37629, 35023] #CHANGE FOR SERVER
